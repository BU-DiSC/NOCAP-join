...
for ratio in ratio_list:
    ...
    cmd = 'python3 vary-buffer-size-emul.py --lTS ' + str(new_R) + ' --rTS ' + str(new_S) + ' --tries ' + str(tries)  + ' --JD ' + str(JD) + ' -k ' + str(k) + ' --OP=emul_vary_both_rels_ratio_zipf_' + str(ratio) + '-' + device + '.txt'
    #print(cmd)
    os.system(cmd)
