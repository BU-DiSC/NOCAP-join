...
python3 vary-buffer-size-emul.py --OP="emul_vary_buffer_size_zipf_alpha_1.0_256-262144-mu-${mu}-tau-${tau}-nosyncio.txt" --JD 3 --JD_ZALPHA 1.0 --tries ${tries}
python3 vary-buffer-size-emul.py --OP="emul_vary_buffer_size_zipf_alpha_0.7_256-262144-mu-${mu}-tau-${tau}-nosyncio.txt" --JD 3 --JD_ZALPHA 0.7 --tries ${tries}

#Exp 2
python3 vary-buffer-size-emul-fig8-direct-io.py --OP="emul_vary_buffer_size_256-262144-mu-${nosync_mu}-tau-${nosync_tau}.txt"  --tries ${tries}
python3 vary-buffer-size-emul-fig8-direct-io.py --OP="emul_vary_buffer_size_zipf_alpha_1.3_256-262144-mu-${nosync_mu}-tau-${nosync_tau}.txt" --JD 3 --JD_ZALPHA 1.3 --tries ${tries}
python3 vary-buffer-size-emul-fig8-direct-io.py --OP="emul_vary_buffer_size_zipf_alpha_1.0_256-262144-mu-${nosync_mu}-tau-${nosync_tau}.txt" --JD 3 --JD_ZALPHA 1.0 --tries ${tries}
python3 vary-buffer-size-emul-fig8-direct-io.py --OP="emul_vary_buffer_size_zipf_alpha_0.7_256-262144-mu-${nosync_mu}-tau-${nosync_tau}.txt" --JD 3 --JD_ZALPHA 0.7 --tries ${tries}



#Exp 3
python3 vary-buffer-size-emul-fig9.py --OP="emul_vary_buffer_size_128-512-mu-${mu}-tau-${tau}-nosyncio.txt"  --tries ${tries}
python3 vary-buffer-size-emul-fig9.py --OP="emul_vary_buffer_size_zipf_alpha_1.0_128-512-mu-${mu}-tau-${tau}-nosyncio-rerun.txt"  --tries ${tries} --JD 3 --JD_ZALPHA 1.0

python3 vary-buffer-size-emul-DHH.py --OP="smaller_buff_emul_vary_DHH_thresholds_zipf_alpha_0.7-mu-${mu}-tau-${tau}-nosyncio.txt" --tries ${tries} --JD 3 --JD_ZALPHA 0.7
python3 vary-buffer-size-emul-DHH.py --OP="smaller_buff_emul_vary_DHH_thresholds-mu-${mu}-tau-${tau}-nosyncio.txt" --tries ${tries} 
#microbenchmark
...
python3 vary-buffer-size-noise-emul.py --OP="emul_vary_buffer_size_zipf_alpha_0.7_256-262144-mu-${mu}-tau-${tau}-noise-stddev-8-nosyncio.txt" --tries ${tries} --JD 3 --JD_ZALPHA 0.7 --NOISE_STDDEV 8
python3 vary-buffer-size-noise-emul.py --OP="emul_vary_buffer_size_256-262144-mu-${mu}-tau-${tau}-noise-stddev-8-nosyncio.txt" --tries ${tries} --NOISE_STDDEV 8
