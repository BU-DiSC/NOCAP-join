...
tau="1.2"
#Exp 1
python3 vary-buffer-size-emul.py --OP="emul_vary_buffer_size_256-262144-mu-${mu}-tau-${tau}-nosyncio.txt"  --tries 2
python3 vary-buffer-size-emul.py --OP="emul_vary_buffer_size_zipf_alpha_1.3_256-262144-mu-${mu}-tau-${tau}-nosyncio.txt" --JD 3 --JD_ZALPHA 1.3 --tries 2
python3 vary-buffer-size-emul.py --OP="emul_vary_buffer_size_zipf_alpha_1.0_256-262144-mu-${mu}-tau-${tau}-nosyncio.txt" --JD 3 --JD_ZALPHA 1.0 --tries 2
python3 vary-buffer-size-emul.py --OP="emul_vary_buffer_size_zipf_alpha_0.7_256-262144-mu-${mu}-tau-${tau}-nosyncio.txt" --JD 3 --JD_ZALPHA 0.7 --tries 2
...
#Exp 3
python3 vary-buffer-size-emul-fig8.py --OP="emul_vary_buffer_size_128-512-mu-${mu}-tau-${tau}-nosyncio.txt"  --tries 2
python3 vary-buffer-size-emul-fig8.py --OP="emul_vary_buffer_size_zipf_alpha_1.0_128-512-mu-${mu}-tau-${tau}-nosyncio.txt"  --tries 2 --JD 3 --JD_ZALPHA 1.0
