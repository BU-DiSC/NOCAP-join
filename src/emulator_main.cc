...
int parse_arguments(int argc, char *argv[], Params & params){
    ...
    args::Flag tpch_q12_low_selectivity_flag_cmd(group1, "TPCH-Q12-Low-Selectivity-Flag", " use the condition with low selectivity (l_receiptdate<l_shipdate) when emulating Q12 in tpc-h dataset", {"tpch-q12-low-selectivity"});
	...
	if(params.clct_part_stats_only_flag){
     ...
     params.tpch_q12_low_selectivity_flag = tpch_q12_low_selectivity_flag_cmd ? args::get(tpch_q12_low_selectivity_flag_cmd) : false;
