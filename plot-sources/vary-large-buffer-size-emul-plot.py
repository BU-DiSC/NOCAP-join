...
GLOBAL_PJM_List = ['HybridApprMatrixDP --RoundedHash','DHH','DHH --DHH_skew_frac_threshold=0.0','SMJ','GHJ','HybridMatrixDP --NoDirectIO --NoSyncIO --RoundedHash']
#color_List = ["chartreuse4","dodgerblue2","black","brown2","lightgoldenrod4","coral3","dodgerblue4","darkgreen"]
color_List = ["#FF6103","#008B45","cyan","#9932CC","slateblue","#CD5B45"]
marker_list = ['s','x','.','^','o','*']
fillstyles = ['none','none','none','none','none','none']
linestyle_list = ['solid','solid','solid','solid','solid','dashed']
label_List = ['NOCAP','DHH','Histojoin','SMJ','GHJ','OCAP']

#GLOBAL_PJM_List = ['HybridApprMatrixDP --RoundedHash','DHH','SMJ','GHJ','HybridMatrixDP --NoDirectIO --NoSyncIO --RoundedHash']
#color_List = ["chartreuse4","dodgerblue2","black","brown2","lightgoldenrod4","coral3","dodgerblue4","darkgreen"]
